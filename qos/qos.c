...
qos_meter_init(void)
{
    ...
    struct rte_meter_srtcm_params app_srtcm_params[APP_FLOWS_MAX] = {
        {.cir=160000000, .cbs=80000000, .ebs=80000000},
        {.cir=80000000, .cbs=40000000, .ebs=40000000},
        {.cir=40000000, .cbs=20000000, .ebs=20000000},
        {.cir=20000000, .cbs=10000000, .ebs=10000000}
    };
    int ret;
